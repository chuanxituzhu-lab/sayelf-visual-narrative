# sayelf-healing-visual-metaphor v0.1
...
- `CONTINUITY LOCK`、`MOTION BUDGET`、`EMOTIONAL PEAK LOCK`、`NO PREACHING`；
...
使用 `examples/rain-acceptance.md` 或 `examples/cliff-hope.md` 对照检查：是否只有一个情绪峰值、每个镜头是否只有一个主运动、连续性锁是否完整、去掉文字后是否仍能读懂关系变化。
