...
`v0.3.3` — plugin manifest and npm package version aligned; the healing visual metaphor Skill is bundled under `skills/` with two locked account character profiles.
